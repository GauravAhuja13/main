...
const Chat = props => {
  ...
  const [singletoggle1, setSingletoggle1] = useState(false);
  const [singletoggle2, setSingletoggle2] = useState(false);
            ...
            <Col md="12" className="d-flex mb-3">
              ...
              <div className="form-check form-switch form-switch-md me-3" style={{ paddingLeft: "2.7rem" }}>
                <input
                  ...
                  onClick={() => setSingletoggle1(!singletoggle1)}
                />
                <label
                ...
                <div style={{display: singletoggle1 ? 'block' : 'none'}} >
                
                <div className="form-inline float-md-end">
                     <div className="search-box ml-2 position-relative" style={{ left:"0px", paddingTop:"10px" }}>
                       <Dropdown
                     // isOpen={singletoggle1}
                     toggle={()=>{}}
                     className="mt-4 mt-sm-0"
                   >
                         <div>
                           <Input 
                             type="text"
                             className="orm-control border-light rounded toggle-search"
                         ...
                         <div className="variant-toggle active"><input type="checkbox" className="me-2"/>Mobiles & Tab » Smartphones » All Smartphones</div>
                         <div className="variant-toggle"><input type="checkbox" className="me-2"/>Mobiles & Tab » Smartphones » PREXD Smartphones</div>
                         <div className="variant-toggle"><input type="checkbox" className="me-2"/>Mobiles & Tab » Smartphones » UNPREXD Smartphones</div>
                                 
                         <div className="">  <p className="mb-0 p-1"> <i class="fa fa-fw fa-cog font-size-15"></i><a href="#" className="text-green"> Manage Category</a> </p> </div>
              ...
              <div className="form-check form-switch form-switch-md me-3" style={{ paddingLeft: "2.7rem" }}>
                <input
                  ...
                  className="form-check-input"
                  id="customSwitchsizemd"
                  onClick={() => setSingletoggle2(!singletoggle1)}
              ...
              <div style={{display: singletoggle2 ? 'block' : 'none'}} >
